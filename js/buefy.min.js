...
!function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t((e = e || self).Buefy = {});
}(void 0, function (e) {
  "use strict";
      ...
      if (s || !Object.assign) {
        var o = Object.getOwnPropertyNames(n).map(function (a) {
          return i({}, a, function (e) {
            return f(n[e]) && null !== t && t.hasOwnProperty(e) && f(t[e]);
          }(a) ? e(t[a], n[a], s) : n[a]);
        }).reduce(function (e, t) {
          return a({}, e, {}, t);
        }, {});
  ...
  function k(e, t) {
    ...
    return JSON.parse(JSON.stringify(e)).sort((i = t, function (e, t) {
      return i.map(function (i) {
        var n = 1;
        return "-" === i[0] && (n = -1, i = i.substring(1)), e[i] > t[i] ? n : e[i] < t[i] ? -n : 0;
      }).reduce(function (e, t) {
        return e || t;
      }, 0);
    }));
  ...
  function D() {
    for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : void 0, t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "long", i = [], n = 0; n < 12; n++) {
      i.push(new Date(2e3, n, 15));
    }
  ...
  function C() {
    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : void 0,
      t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "narrow",
      i = [],
      n = new Date(2e3, 0, 1),
      a = n.getDay();
    n.setDate(n.getDate() - a);
    for (var s = 0; s < 7; s++) {
      i.push(new Date(n.getFullYear(), n.getMonth(), n.getDate() + s));
    }
    var o = new Intl.DateTimeFormat(e, {
      weekday: t,
      timezome: "UTC"
    });
    return i.map(function (e) {
    ...
    F = {
      ...
      methods: {
        ...
        getElement: function getElement() {
          for (var e = this.$refs[this.$data._elementRef]; y(e);) {
            e = e.$refs[e.$data._elementRef];
          }
          return e;
        },
        ...
        setValidity: function setValidity(e, t) {
          var i = this;
  ...
  var O = function O(e, t, i, n, a, s, o, r, l, c) {
    "boolean" != typeof o && (l = r, r = o, o = !1);
    var u,
      d = "function" == typeof i ? i.options : i;
    if (e && e.render && (d.render = e.render, d.staticRenderFns = e.staticRenderFns, d._compiled = !0, a && (d.functional = !0)), n && (d._scopeId = n), s ? (u = function u(e) {
  ...
  var I = O({
    ...
    computed: {
      ...
      newType: function newType() {
        if (this.type) {
          var e = [];
          if ("string" == typeof this.type) e = this.type.split("-");else for (var t in this.type) {
            if (this.type[t]) {
              e = t.split("-");
              break;
            }
    ...
    methods: {
      getEquivalentIconOf: function getEquivalentIconOf(e) {
  ...
  var E = O({
    ...
    computed: {
      ...
      rightIconType: function rightIconType() {
        return this.passwordReveal ? "is-primary" : this.iconRight ? null : this.statusType;
      },
    ...
    methods: {
      ...
      iconClick: function iconClick(e, t) {
        var i = this;
        this.$emit(e, t), this.$nextTick(function () {
          i.focus();
        });
      },
      rightIconClick: function rightIconClick(e) {
  ...
  var R = O({
      render: function render() {
        ...
        return i("div", {
          ...
          on: {
            ...
            "icon-click": function iconClick(t) {
      ...
      methods: {
        setHovered: function setHovered(e) {
        ...
        setSelected: function setSelected(e) {
          ...
          void 0 !== e && (this.selected = e, this.$emit("select", this.selected, n), null !== this.selected && (this.newValue = this.clearOnSelect ? "" : this.getValue(this.selected), this.setHovered(null)), i && this.$nextTick(function () {
            t.isActive = !1;
          }), this.checkValidity());
        },
        selectFirstOption: function selectFirstOption(e) {
          var t = this;
          this.$nextTick(function () {
            if (e.length) {
              var i = e[0].items[0];
              (t.openOnFocus || "" !== t.newValue && t.hovered !== i) && t.setHovered(i);
            } else t.setHovered(null);
          });
        },
        keydown: function keydown(e) {
          var t = e.key;
          if (this.isActive = "Tab" !== t, null !== this.hovered && this.confirmKeys.indexOf(t) >= 0) {
            "," === t && e.preventDefault();
            var i = !this.keepOpen || "Tab" === t;
            this.setSelected(this.hovered, i, e);
          }
        },
        clickedOutside: function clickedOutside(e) {
          var t = $(this) ? e.composedPath()[0] : e.target;
          !this.hasFocus && this.whiteList.indexOf(t) < 0 && (this.isActive = !1);
        },
        getValue: function getValue(e) {
          if (null !== e) return void 0 !== this.customFormatter ? this.customFormatter(e) : "object" === t(e) ? h(e, this.field) : e;
        },
        checkIfReachedTheEndOfScroll: function checkIfReachedTheEndOfScroll(e) {
        ...
        keyArrows: function keyArrows(e) {
          var t = "down" === e ? 1 : -1;
          if (this.isActive) {
  ...
  var K = function K(e) {
    ...
    return c(t, 1) && (n.data = function () {
      ...
      _registerItem: function _registerItem(e) {
        this.childItems.push(e);
      },
      _unregisterItem: function _unregisterItem(e) {
        this.childItems = this.childItems.filter(function (t) {
          return t !== e;
        });
      }
    }, c(t, 3) && (n.watch = {
      childItems: function childItems(e) {
          ...
          !function n(a) {
            ...
            try {
              for (var l, c = function c() {
                ...
                }, u = a[Symbol.iterator](); !(s = (l = u.next()).done); s = !0) {
                c();
              }
            } catch (e) {
              o = !0, r = e;
  ...
  var U = O({
      ...
      methods: {
        ...
        changeActive: function changeActive(e) {
          var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0;
          this.activeChild === e || isNaN(e) || (t = t || e - this.activeChild, e = this.repeat ? u(e, this.childItems.length) : d(e, 0, this.childItems.length - 1), this.transition = t > 0 ? "prev" : "next", this.activeChild = e, e !== this.value && this.$emit("input", e), this.$emit("change", e));
        },
        modeChange: function modeChange(e, t) {
    ...
    q = function q(e) {
      var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
        i = {
          ...
          created: function created() {
            if (this.parent) this.parent._registerItem && this.parent._registerItem(this);else if (!c(t, 2)) throw this.$destroy(), new Error("You should wrap " + this.$options.name + " in a " + e);
          },
          beforeDestroy: function beforeDestroy() {
  ...
  var Q = O({
      ...
      watch: {
        ...
        scrollValue: function scrollValue(e) {
          this.switchTo(e);
        }
      },
      methods: {
        ...
        checkAsIndicator: function checkAsIndicator(e, t) {
          if (this.asIndicator) {
  ...
  var ae,
    ...
    re = {
      ...
      computed: {
        ...
        hours: function hours() {
          ...
          for (var e = [], t = this.isHourFormat24 ? 24 : 12, i = 0; i < t; i += this.incrementHours) {
            var n = i,
              a = n;
            this.isHourFormat24 || (a = n = i + 1, this.meridienSelected === this.amString || this.meridienSelected === this.AM ? 12 === n && (n = 0) : this.meridienSelected !== this.pmString && this.meridienSelected !== this.PM || 12 !== n && (n += 12)), e.push({
      ...
      methods: {
        onMeridienChange: function onMeridienChange(e) {
          null !== this.hoursSelected && this.resetOnMeridianChange ? (this.hoursSelected = null, this.minutesSelected = null, this.secondsSelected = null, this.computedValue = null) : null !== this.hoursSelected && (e === this.pmString || e === oe ? this.hoursSelected += 12 : e !== this.amString && e !== se || (this.hoursSelected -= 12)), this.updateDateSelected(this.hoursSelected, this.minutesSelected, this.enableSeconds ? this.secondsSelected : 0, e);
        },
        onHoursChange: function onHoursChange(e) {
        ...
        updateInternalState: function updateInternalState(e) {
        ...
        isHourDisabled: function isHourDisabled(e) {
          var t = this,
            i = !1;
          if (this.minTime) {
        ...
        isMinuteDisabledForHour: function isMinuteDisabledForHour(e, t) {
          var i = !1;
          if (this.minTime) {
            var n = this.minTime.getHours(),
        ...
        isMinuteDisabled: function isMinuteDisabled(e) {
          var t = this,
            i = !1;
        ...
        isSecondDisabled: function isSecondDisabled(e) {
          var t = this,
            i = !1;
          if (null !== this.minutesSelected) {
            if (this.isMinuteDisabled(this.minutesSelected)) i = !0;else {
              if (this.minTime) {
                var n = this.minTime.getHours(),
                  a = this.minTime.getMinutes(),
            ...
            if (this.unselectableTimes) if (!i) i = this.unselectableTimes.filter(function (i) {
        ...
        formatHHMMSS: function formatHHMMSS(e) {
          var t = new Date(e);
          if (e && !isNaN(t)) {
            var i = t.getHours(),
              n = t.getMinutes(),
        ...
        onChangeNativePicker: function onChangeNativePicker(e) {
          var t = e.target.value;
          if (t) {
            var i = null;
  ...
  var de = O({
    ...
    methods: {
      selectItem: function selectItem(e) {
        ...
        } else this.selected !== e && (this.selected = e, this.$emit("change", this.selected));
        this.$emit("input", this.selected), this.multiple || (this.isActive = !this.closeOnClick, this.hoverable && this.closeOnClick && (this.isHoverable = !1));
      },
      isInWhiteList: function isInWhiteList(e) {
      ...
      updateAppendToBody: function updateAppendToBody() {
        ...
        if (i && n) {
          ...
          if (a.classList.forEach(function (e) {
            ...
            if (e && "object" === t(e)) for (var i in e) {
              e[i] && a.classList.add(i);
            }
  ...
  var fe = O({
    ...
    computed: {
      ...
      formattedMessage: function formattedMessage() {
        ...
        if (Array.isArray(this.newMessage)) this.newMessage.forEach(function (t) {
          if ("string" == typeof t) e.push(t);else for (var i in t) {
            t[i] && e.push(i);
          }
        });else for (var t in this.newMessage) {
    ...
    watch: {
      ...
      newMessage: function newMessage(e) {
  ...
  var me,
    ve = O({
      ...
      methods: {
        ...
        euclidean: function euclidean(e, t) {
          var i = t.x - e.x,
            n = t.y - e.y;
          return Math.sqrt(i * i + n * n);
        },
        shortestDistanceDegrees: function shortestDistanceDegrees(e, t) {
          var i = (t - e) % 360,
            n = 180 - Math.abs(Math.abs(i) - 180);
          return (i + 360) % 360 < 180 ? 1 * n : -1 * n;
        },
        coordToAngle: function coordToAngle(e, t) {
          var i = 2 * Math.atan2(t.y - e.y - this.euclidean(e, t), t.x - e.x);
          return Math.abs(180 * i / Math.PI);
        },
        getNumberTranslate: function getNumberTranslate(e) {
          var t = this.getNumberCoords(e),
            i = t.x,
            n = t.y;
          return "translate(".concat(i, "px, ").concat(n, "px)");
        },
        getNumberCoords: function getNumberCoords(e) {
  ...
  var ge = O({
      ...
      name: "BClockpicker",
      components: (me = {}, i(me, ve.name, ve), i(me, E.name, E), i(me, fe.name, fe), i(me, I.name, I), i(me, de.name, de), i(me, he.name, he), me),
      mixins: [re],
      props: {
        pickerSize: {
          type: Number,
      ...
      computed: {
        hoursDisplay: function hoursDisplay() {
          ...
          return this.meridienSelected !== this.pmString && this.meridienSelected !== this.PM || (e -= 12), 0 === e && (e = 12), e;
        },
        minutesDisplay: function minutesDisplay() {
          return null == this.minutesSelected ? "--" : this.pad(this.minutesSelected);
        },
        minFaceValue: function minFaceValue() {
          return !this.isSelectingHour || this.isHourFormat24 || this.meridienSelected !== this.pmString && this.meridienSelected !== this.PM ? 0 : 12;
        },
        maxFaceValue: function maxFaceValue() {
          return this.isSelectingHour ? this.isHourFormat24 || this.meridienSelected !== this.amString && this.meridienSelected !== this.AM ? 23 : 11 : 59;
        },
      ...
      methods: {
        onClockInput: function onClockInput(e) {
        ...
        onMeridienClick: function onMeridienClick(e) {
  ...
  var we = O({
    ...
    methods: {
      firstWeekOffset: function firstWeekOffset(e, t, i) {
        var n = 7 + t - i;
      ...
      getSetDayOfYear: function getSetDayOfYear(e) {
        return Math.round((e - new Date(e.getFullYear(), 0, 1)) / 864e5) + 1;
      },
      weeksInYear: function weeksInYear(e, t, i) {
      ...
      clickWeekNumber: function clickWeekNumber(e) {
        this.weekNumberClickable && this.$datepicker.$emit("week-number-click", e);
      },
      selectableDate: function selectableDate(e) {
        var t = [];
        if (this.minDate && t.push(e >= this.minDate), this.maxDate && t.push(e <= this.maxDate), this.nearbyMonthDays && !this.nearbySelectableMonthDays && t.push(e.getMonth() === this.month), this.selectableDates) for (var i = 0; i < this.selectableDates.length; i++) {
          var n = this.selectableDates[i];
          if (e.getDate() === n.getDate() && e.getFullYear() === n.getFullYear() && e.getMonth() === n.getMonth()) return !0;
          t.push(!1);
        }
        if (this.unselectableDates) for (var a = 0; a < this.unselectableDates.length; a++) {
          var s = this.unselectableDates[a];
          t.push(e.getDate() !== s.getDate() || e.getFullYear() !== s.getFullYear() || e.getMonth() !== s.getMonth());
        }
        if (this.unselectableDaysOfWeek) for (var o = 0; o < this.unselectableDaysOfWeek.length; o++) {
          var r = this.unselectableDaysOfWeek[o];
          t.push(e.getDay() !== r);
        }
        return t.indexOf(!1) < 0;
      },
      emitChosenDate: function emitChosenDate(e) {
        this.disabled || this.selectableDate(e) && this.$emit("select", e);
      },
      eventsDateMatch: function eventsDateMatch(e) {
        if (!this.events || !this.events.length) return !1;
        for (var t = [], i = 0; i < this.events.length; i++) {
          this.events[i].date.getDay() === e.getDay() && t.push(this.events[i]);
        }
        return !!t.length && t;
      },
      classObject: function classObject(e) {
        function t(e, t, i) {
        ...
        return {
          "is-selected": t(e, this.selectedDate) || i(e, this.selectedDate, this.multiple),
          "is-first-selected": t(e, Array.isArray(this.selectedDate) && this.selectedDate[0], this.multiple),
          "is-within-selected": i(e, this.selectedDate, this.multiple),
      ...
      setRangeHoverEndDate: function setRangeHoverEndDate(e) {
        this.range && this.$emit("rangeHoverEndDate", e);
      },
      manageKeydown: function manageKeydown(e, t) {
        switch (e.key) {
          case " ":
          case "Space":
          case "Spacebar":
      ...
      changeFocus: function changeFocus(e, t) {
        var i = e;
        for (i.setDate(e.getDate() + t); (!this.minDate || i > this.minDate) && (!this.maxDate || i < this.maxDate) && !this.selectableDate(i);) {
          i.setDate(e.getDate() + Math.sign(t));
        }
        this.$emit("change-focus", i);
      }
    }
  }, void 0, !1, void 0, void 0, void 0);
  var ke = O({
    ...
    methods: {
      ...
      handleSelectRangeDate: function handleSelectRangeDate(e) {
      ...
      handleSelectMultipleDates: function handleSelectMultipleDates(e) {
      ...
      weekBuilder: function weekBuilder(e, t, i) {
        for (var n = new Date(i, t), a = [], s = new Date(i, t, e).getDay(), o = s >= this.firstDayOfWeek ? s - this.firstDayOfWeek : 7 - this.firstDayOfWeek + s, r = 1, l = 0; l < o; l++) {
          a.unshift(new Date(n.getFullYear(), n.getMonth(), e - r)), r++;
        }
        a.push(new Date(i, t, e));
        for (var c = 1; a.length < 7;) {
          a.push(new Date(i, t, e + c)), c++;
        }
        return a;
      },
      validateFocusedDay: function validateFocusedDay() {
        var e = new Date(this.focused.year, this.focused.month, this.focused.day);
        if (!this.selectableDate(e)) for (var t = 0, i = new Date(this.focused.year, this.focused.month + 1, 0).getDate(), n = null; !n && ++t < i;) {
      ...
      selectableDate: function selectableDate(e) {
        var t = [];
        if (this.minDate && t.push(e >= this.minDate), this.maxDate && t.push(e <= this.maxDate), this.nearbyMonthDays && !this.nearbySelectableMonthDays && t.push(e.getMonth() === this.focused.month), this.selectableDates) for (var i = 0; i < this.selectableDates.length; i++) {
          var n = this.selectableDates[i];
          if (e.getDate() === n.getDate() && e.getFullYear() === n.getFullYear() && e.getMonth() === n.getMonth()) return !0;
          t.push(!1);
        }
      ...
      eventsInThisWeek: function eventsInThisWeek(e) {
  ...
  var Se,
    De = O({
      ...
      watch: {
        focusedMonth: function focusedMonth(e) {
          var t = this,
            i = "month-".concat(e);
      ...
      methods: {
        selectMultipleDates: function selectMultipleDates(e) {
          this.multipleSelectedDates.filter(function (t) {
            return t.getDate() === e.getDate() && t.getFullYear() === e.getFullYear() && t.getMonth() === e.getMonth();
          }).length ? this.multipleSelectedDates = this.multipleSelectedDates.filter(function (t) {
            return t.getDate() !== e.getDate() || t.getFullYear() !== e.getFullYear() || t.getMonth() !== e.getMonth();
        ...
        selectableDate: function selectableDate(e) {
          var t = [];
          if (this.minDate && t.push(e >= this.minDate), this.maxDate && t.push(e <= this.maxDate), t.push(e.getFullYear() === this.focused.year), this.selectableDates) for (var i = 0; i < this.selectableDates.length; i++) {
            var n = this.selectableDates[i];
        ...
        eventsDateMatch: function eventsDateMatch(e) {
          ...
          for (var t = [], i = 0; i < this.eventsInThisYear.length; i++) {
            this.eventsInThisYear[i].date.getMonth() === e.getMonth() && t.push(this.events[i]);
          }
          return !!t.length && t;
        },
        classObject: function classObject(e) {
    ...
    xe = O({
      render: function render() {
        ...
        return i("div", {
          ...
          on: {
            "range-start": function rangeStart(t) {
              return e.$emit("range-start", t);
            },
            "range-end": function rangeEnd(t) {
            ...
            "change-focus": e.changeFocus,
            "update:focused": function updateFocused(t) {
              e.focusedDateData = t;
            }
          },
          model: {
      ...
      name: "BDatepicker",
      components: (Se = {}, i(Se, ke.name, ke), i(Se, De.name, De), i(Se, E.name, E), i(Se, fe.name, fe), i(Se, ye.name, ye), i(Se, I.name, I), i(Se, de.name, de), i(Se, he.name, he), Se),
      mixins: [F],
      inheritAttrs: !1,
      provide: function provide() {
        return {
      ...
      data: function data() {
        ...
        return !this.value && this.maxDate && this.maxDate.getFullYear() < new Date().getFullYear() && e.setFullYear(this.maxDate.getFullYear()), {
          dateSelected: this.value,
          focusedDateData: {
            day: e.getDate(),
            month: e.getMonth(),
      ...
      watch: {
        ...
        focusedDate: function focusedDate(e) {
        ...
        "focusedDateData.month": function focusedDateDataMonth(e) {
          this.$emit("change-month", e);
        },
        "focusedDateData.year": function focusedDateDataYear(e) {
      ...
      methods: {
        ...
        formatNative: function formatNative(e) {
          return this.isTypeMonth ? this.formatYYYYMM(e) : this.formatYYYYMMDD(e);
        },
        formatYYYYMMDD: function formatYYYYMMDD(e) {
          var t = new Date(e);
          if (e && !isNaN(t)) {
            var i = t.getFullYear(),
              n = t.getMonth() + 1,
        ...
        formatYYYYMM: function formatYYYYMM(e) {
          var t = new Date(e);
          if (e && !isNaN(t)) {
            var i = t.getFullYear(),
              n = t.getMonth() + 1;
        ...
        updateInternalState: function updateInternalState(e) {
          var t = Array.isArray(e) ? e.length ? e[0] : this.dateCreator() : e || this.dateCreator();
        ...
        togglePicker: function togglePicker(e) {
          this.$refs.dropdown && this.closeOnClick && (this.$refs.dropdown.isActive = "boolean" == typeof e ? e : !this.$refs.dropdown.isActive);
        },
  ...
  var $e,
    Pe = O({
      ...
      name: "BTimepicker",
      components: (Ce = {}, i(Ce, E.name, E), i(Ce, fe.name, fe), i(Ce, ye.name, ye), i(Ce, I.name, I), i(Ce, de.name, de), i(Ce, he.name, he), Ce),
      mixins: [re],
      inheritAttrs: !1,
      data: function data() {
        return {
  ...
  var Be = O({
      render: function render() {
        ...
        return !e.isMobile || e.inline ? i("b-datepicker", e._b({
          ...
          on: {
            focus: e.onFocus,
            blur: e.onBlur,
            "change-month": function changeMonth(t) {
              return e.$emit("change-month", t);
            },
            "change-year": function changeYear(t) {
      ...
      methods: {
        ...
        adjustValue: function adjustValue(e) {
          var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
          return e ? t ? new Date(e.getTime() - 6e4 * this.tzOffset) : new Date(e.getTime() + 6e4 * this.tzOffset) : e;
        },
        defaultDatetimeParser: function defaultDatetimeParser(e) {
        ...
        defaultDatetimeFormatter: function defaultDatetimeFormatter(e) {
  ...
  function Ve(e) {
    ...
    var i = new (("undefined" != typeof window && window.Vue ? window.Vue : Me || P).extend(Fe))({
  ...
  var Le = O({
      ...
      props: {
        ...
        srcsetFormatter: {
          type: Function,
          "default": function _default(e, t, i) {
      ...
      methods: {
        ...
        formatSrcset: function formatSrcset(e, t) {
  ...
  var Ke,
    Ue = O({
      ...
      watch: {
        ...
        isFullPage: function isFullPage(e) {
    ...
    qe = {
      open: function open(e) {
        ...
        return new (("undefined" != typeof window && window.Vue ? window.Vue : Ke || P).extend(Ue))({
          el: document.createElement("div"),
          propsData: t
        });
      }
  ...
  var Je = O({
      ...
      methods: {
        ...
        getMenu: function getMenu() {
          for (var e = this.$parent; e && !e.$data._isMenu;) {
            e = e.$parent;
          }
          return e;
        }
  ...
  var ot = O({
    ...
    rt = {
      ...
      methods: {
        ...
        close: function close() {
          var e = this;
          clearTimeout(this.timer), this.isActive = !1, this.$emit("close"), setTimeout(function () {
            e.$destroy(), g(e.$el);
          }, 150);
        },
  ...
  var ht = O({
    ...
    pt = "undefined" != typeof window && ("ontouchstart" in window || navigator.msMaxTouchPoints > 0) ? ["touchstart", "click"] : ["click"],
    ft = [];
  function mt(e) {
    var i = "function" == typeof e;
    if (!i && "object" !== t(e)) throw new Error("v-click-outside: Binding value should be a function or an object, typeof ".concat(e, " given"));
    return {
  ...
  var gt = {
    bind: function bind(e, t) {
      ...
      o.eventHandlers.forEach(function (e) {
        var t = e.event,
          i = e.handler;
    ...
    update: function update(e, t) {
      ...
      }), o.eventHandlers = s.map(function (t) {
        return {
          event: t,
          handler: function handler(t) {
            return vt({
    ...
    unbind: function unbind(e) {
      ft.filter(function (t) {
        return t.el === e;
      })[0].eventHandlers.forEach(function (e) {
        var t = e.event,
          i = e.handler;
        return document.removeEventListener(t, i);
      });
  ...
  var bt = O({}, void 0, {
      ...
      methods: {
        ...
        setBodyClass: function setBodyClass(e) {
          "undefined" != typeof window && document.body.classList.add(e);
        },
        removeBodyClass: function removeBodyClass(e) {
        ...
        genNavbar: function genNavbar(e) {
        ...
        genNavbarSlots: function genNavbarSlots(e, t) {
          return e("nav", {
            staticClass: "navbar",
        ...
        genNavbarBrandNode: function genNavbarBrandNode(e) {
          return e("div", {
            "class": "navbar-brand"
          }, [this.$slots.brand, this.genBurgerNode(e)]);
        },
        genBurgerNode: function genBurgerNode(e) {
        ...
        genNavbarSlotsNode: function genNavbarSlotsNode(e) {
          return e("div", {
        ...
        genMenuPosition: function genMenuPosition(e, t) {
          return e("div", {
  ...
  var wt = O({
    ...
    methods: {
      ...
      closeMenuRecursive: function closeMenuRecursive(e, t) {
  ...
  var kt,
    St = O({
      render: function render() {
        ...
        }, [e.label ? [e._v(e._s(e.label))] : e._t("label")], 2), i("div", {
          directives: [{
            name: "show",
            rawName: "v-show",
  ...
  var Ct = O({
      render: function render() {
        ...
        return i("div", {
          ...
          return i("p", {
            ...
            attrs: {
              type: "button",
              disabled: e.disabled || "plus" === t ? e.disabledMax : e.disabledMin
            },
            on: {
              mousedown: function mousedown(i) {
                return e.onStartLongPress(i, "plus" === t);
              },
              touchstart: function touchstart(i) {
                return i.preventDefault(), e.onStartLongPress(i, "plus" === t);
              },
              click: function click(i) {
                return e.onControlClick(i, "plus" === t);
              }
            }
          }, [i("b-icon", {
            attrs: {
      ...
      name: "BNumberinput",
      components: (kt = {}, i(kt, I.name, I), i(kt, E.name, E), kt),
      mixins: [F],
      inheritAttrs: !1,
      props: {
        value: Number,
      ...
      computed: {
        computedValue: {
          ...
          set: function set(e) {
            var t = e;
            "" !== e && null != e || (t = void 0 !== this.minNumber ? this.minNumber : null), this.newValue = t, this.$emit("input", t), !this.isValid && this.$refs.input.checkHtml5Validity();
          }
        },
  ...
  var Pt = O({
      ...
      name: "BPagination",
      components: (_t = {}, i(_t, I.name, I), i(_t, $t.name, $t), _t),
      model: {
        prop: "current",
      ...
      watch: {
        pageCount: function pageCount(e) {
      ...
      methods: {
        ...
        getAriaPageLabel: function getAriaPageLabel(e, t) {
  ...
  var Tt = O({
    ...
    watch: {
      isIndeterminate: function isIndeterminate(e) {
        var t = this;
        this.$nextTick(function () {
    ...
    methods: {
      calculateValue: function calculateValue(e) {
        if (null != e && !isNaN(e)) {
  ...
  var Ot = O({
      ...
      methods: {
        ...
        previewRate: function previewRate(e, t) {
  ...
  var Rt = O({}, void 0, {
      ...
      render: function render(e, t) {
        if (t.props.active) {
          for (var i = [], n = t.props.width, a = t.props.height, s = 0; s < t.props.count; s++) {
            i.push(e("div", {
      ...
      updateAppendToBody: function updateAppendToBody() {
        ...
        if (e && i) {
          ...
          n.classList.forEach(function (e) {
            ...
            if ("object" === t(e)) for (var i in e) {
              e[i] && n.classList.add(i);
  ...
  var Yt,
    Kt = O({
      ...
      methods: {
        getTickStyle: function getTickStyle(e) {
          return {
            left: e + "%"
          };
        }
  ...
  var Ut = O({
      ...
      name: "BSlider",
      components: (Yt = {}, i(Yt, jt.name, jt), i(Yt, Kt.name, Kt), Yt),
      props: {
        value: {
          type: [Number, Array],
          "default": 0
      ...
      computed: {
        ...
        tickValues: function tickValues() {
          ...
          for (var e = [], t = this.min + this.step; t < this.max; t += this.step) {
            e.push(t);
          }
          return e;
        },
      ...
      methods: {
        ...
        emitValue: function emitValue(e) {
  ...
  var Xt,
    ...
    Gt = {
      open: function open(e) {
        ...
        var a = m(n, e),
          s = new (("undefined" != typeof window && window.Vue ? window.Vue : Xt || P).extend(Qt))({
            parent: t,
            el: document.createElement("div"),
            propsData: a
          });
  ...
  var Zt = {
    ...
    ei = function ei(e) {
      ...
      return {
        mixins: [K(e, 3)],
        components: (t = {}, i(t, I.name, I), i(t, Zt.name, Zt), t),
        props: {
          value: {
            type: [String, Number],
            "default": void 0
        ...
        watch: {
          ...
          activeId: function activeId(e, t) {
  ...
  var ti = O({
      ...
      computed: {
        ...
        nextItem: function nextItem() {
          for (var e = null, t = this.activeItem ? this.items.indexOf(this.activeItem) + 1 : 0; t < this.items.length; t++) {
        ...
        prevItem: function prevItem() {
          ...
          for (var e = null, t = this.items.indexOf(this.activeItem) - 1; t >= 0; t--) {
            if (this.items[t].visible) {
              e = this.items[t];
              break;
            }
      ...
      methods: {
        isItemClickable: function isItemClickable(e) {
  ...
  var li = O({
    ...
    components: (si = {}, i(si, ye.name, ye), i(si, I.name, I), si),
    props: {
    ...
    methods: {
      ...
      getSortingObjectOfColumn: function getSortingObjectOfColumn(e) {
        return this.sortMultipleData.filter(function (t) {
          return t.field === e.field;
        })[0];
      },
      columnIsDesc: function columnIsDesc(e) {
  ...
  var ui,
    di = O({
      ...
      watch: {
        currentPage: function currentPage(e) {
  ...
  var hi = O({
      render: function render() {
        ...
        return i("div", {
          ...
          on: {
            sort: function sort(t, i) {
              return e.sort(t, null, i);
            },
            removePriority: function removePriority(t) {
          ...
          on: {
            "update:currentPage": function updateCurrentPage(t) {
              e.newCurrentPage = t;
            },
            "update:current-page": function updateCurrentPage(t) {
              e.newCurrentPage = t;
            },
            "page-change": function pageChange(t) {
        ...
        }, [e.newColumns.length && e.showHeader ? i("thead", [i("tr", [e.showDetailRowIcon ? i("th", {
          attrs: {
            width: "40px"
          }
          ...
          return i("th", {
            ...
            "class": [t.headerClass, {
              ...
              "is-sticky": t.sticky,
              "is-unselectable": t.isHeaderUnSelectable
            }],
            style: t.style,
            on: {
              click: function click(i) {
            ...
            "class": {
              "is-desc": !e.isAsc,
              "is-invisible": e.currentSortColumn !== t
            },
            attrs: {
              icon: e.sortIcon,
              pack: e.iconPack,
          ...
          return [i("tr", {
            ...
            on: {
              ...
              dblclick: function dblclick(i) {
                return e.$emit("dblclick", t);
              },
              mouseenter: function mouseenter(i) {
                e.$listeners.mouseenter && e.$emit("mouseenter", t);
              },
              mouseleave: function mouseleave(i) {
                e.$listeners.mouseleave && e.$emit("mouseleave", t);
              },
              contextmenu: function contextmenu(i) {
                return e.$emit("contextmenu", t, i);
              },
              dragstart: function dragstart(i) {
                return e.handleDragStart(i, t, n);
              },
              dragend: function dragend(i) {
                return e.handleDragEnd(i, t, n);
              },
              drop: function drop(i) {
                return e.handleDrop(i, t, n);
              },
              dragover: function dragover(i) {
                return e.handleDragOver(i, t, n);
              },
              dragleave: function dragleave(i) {
            ...
            return [a.$scopedSlots && a.$scopedSlots["default"] ? [i("b-slot-component", {
              key: a.newKey + ":" + n + ":" + s,
              "class": a.rootClasses,
              attrs: {
                component: a,
          ...
          })], 1) : e._e()], 2), e.isActiveDetailRow(t) ? i("tr", {
          ...
          on: {
            "update:active": function updateActive(t) {
              e.loading = t;
            }
          }
      ...
      name: "BTable",
      components: (ui = {}, i(ui, Z.name, Z), i(ui, I.name, I), i(ui, E.name, E), i(ui, Ue.name, Ue), i(ui, Zt.name, Zt), i(ui, li.name, li), i(ui, ci.name, ci), i(ui, di.name, di), ui),
      inheritAttrs: !1,
      provide: function provide() {
        return {
          $table: this
      ...
      computed: {
        ...
        isAllChecked: function isAllChecked() {
          ...
          var i = t.some(function (t) {
            return p(e.newCheckedRows, t, e.customIsChecked) < 0;
          });
          return !i;
        },
      ...
      watch: {
        ...
        newCurrentPage: function newCurrentPage(e) {
          this.$emit("update:currentPage", e);
        },
        checkedRows: function checkedRows(e) {
        ...
        openedDetailed: function openedDetailed(e) {
          this.visibleDetailRows = e;
        }
      },
      methods: {
        onFiltersEvent: function onFiltersEvent(e) {
          this.$emit("filters-event-".concat(this.filtersEvent), {
            event: e,
            filters: this.filters
          });
        },
        handleFiltersChange: function handleFiltersChange(e) {
          var t = this;
        ...
        findIndexOfSortData: function findIndexOfSortData(e) {
          var t = this.sortMultipleDataComputed.filter(function (t) {
            return t.field === e.field;
          })[0];
          return this.sortMultipleDataComputed.indexOf(t) + 1;
        },
        removeSortingPriority: function removeSortingPriority(e) {
          if (this.backendSorting) this.$emit("sorting-priority-removed", e.field);else {
        ...
        sortBy: function sortBy(e, t, i, n) {
        ...
        sortMultiColumn: function sortMultiColumn(e) {
        ...
        sort: function sort(e) {
          ...
          if (!this.backendSorting && this.sortMultiple && (this.sortMultipleKey && i[this.sortMultipleKey] || !this.sortMultipleKey)) t ? this.doSortMultiColumn() : this.sortMultiColumn(e);else {
            if (!e || !e.sortable) return;
            this.sortMultiple && (this.sortMultipleDataLocal = []), t || (this.isAsc = e === this.currentSortColumn ? !this.isAsc : "desc" !== this.defaultSortDirection.toLowerCase()), this.firstTimeSort || this.$emit("sort", e.field, this.isAsc ? "asc" : "desc", i), this.backendSorting || this.doSortSingleColumn(e), this.currentSortColumn = e;
          }
        },
        doSortSingleColumn: function doSortSingleColumn(e) {
          this.newData = this.sortBy(this.newData, e.field, e.customSort, this.isAsc);
        },
        isRowSelected: function isRowSelected(e, t) {
          return !!t && (this.customRowKey ? e[this.customRowKey] === t[this.customRowKey] : e === t);
        },
        isRowChecked: function isRowChecked(e) {
          return p(this.newCheckedRows, e, this.customIsChecked) >= 0;
        },
        removeCheckedRow: function removeCheckedRow(e) {
          var t = p(this.newCheckedRows, e, this.customIsChecked);
        ...
        checkRow: function checkRow(e, t, i) {
        ...
        shiftCheckRow: function shiftCheckRow(e, t, i) {
          var n = this,
        ...
        selectRow: function selectRow(e, t) {
        ...
        openDetailRow: function openDetailRow(e) {
          var t = this.handleDetailKey(e);
          this.visibleDetailRows.push(t);
        },
        closeDetailRow: function closeDetailRow(e) {
          var t = this.handleDetailKey(e),
            i = this.visibleDetailRows.indexOf(t);
          this.visibleDetailRows.splice(i, 1);
        },
        isVisibleDetailRow: function isVisibleDetailRow(e) {
          var t = this.handleDetailKey(e);
          return this.visibleDetailRows.indexOf(t) >= 0;
        },
        isActiveDetailRow: function isActiveDetailRow(e) {
          return this.detailed && !this.customDetailRow && this.isVisibleDetailRow(e);
        },
        isActiveCustomDetailRow: function isActiveCustomDetailRow(e) {
          return this.detailed && this.customDetailRow && this.isVisibleDetailRow(e);
        },
        isRowFiltered: function isRowFiltered(e) {
          var i = this,
            n = function n(t) {
              ...
              if (a && a.customSearch && "function" == typeof a.customSearch) return {
                v: a.customSearch(e, n)
              };
        ...
        handleDetailKey: function handleDetailKey(e) {
        ...
        checkSort: function checkSort() {
          if (this.newColumns.length && this.firstTimeSort) this.initSort(), this.firstTimeSort = !1;else if (this.newColumns.length && Object.keys(this.currentSortColumn).length > 0) for (var e = 0; e < this.newColumns.length; e++) {
        ...
        pressedArrow: function pressedArrow(e) {
          if (this.visibleData.length) {
            ...
            if (this.isRowSelectable(i)) this.selectRow(i);else {
              var n = null;
              if (e > 0) for (var a = t; a < this.visibleData.length && null === n; a++) {
                this.isRowSelectable(this.visibleData[a]) && (n = a);
              } else for (var s = t; s >= 0 && null === n; s--) {
                this.isRowSelectable(this.visibleData[s]) && (n = s);
              }
        ...
        handleDragStart: function handleDragStart(e, t, i) {
          this.draggable && this.$emit("dragstart", {
            event: e,
            row: t,
            index: i
          });
        },
        handleDragEnd: function handleDragEnd(e, t, i) {
        ...
        handleDrop: function handleDrop(e, t, i) {
          this.draggable && this.$emit("drop", {
            event: e,
            row: t,
            index: i
          });
        },
        handleDragOver: function handleDragOver(e, t, i) {
          this.draggable && this.$emit("dragover", {
            event: e,
            row: t,
            index: i
          });
        },
        handleDragLeave: function handleDragLeave(e, t, i) {
          this.draggable && this.$emit("dragleave", {
            event: e,
            row: t,
            index: i
          });
  ...
  var fi = O({
    ...
    computed: {
      ...
      navClasses: function navClasses() {
        var e;
        return [this.type, this.size, (e = {}, i(e, this.position, this.position && !this.vertical), i(e, "is-fullwidth", this.expanded), i(e, "is-toggle-rounded is-toggle", "is-toggle-rounded" === this.type), e)];
      }
    }
  }, void 0, !1, void 0, void 0, void 0);
  var mi = O({}, void 0, {
  ...
  var ki = O({
      ...
      name: "BTaginput",
      components: (bi = {}, i(bi, R.name, R), i(bi, gi.name, gi), bi),
      mixins: [F],
      inheritAttrs: !1,
      props: {
        value: {
      ...
      methods: {
        addTag: function addTag(e) {
          ...
          if (t) {
            if (!this.autocomplete) {
              ...
              if (i && t.match(i)) return void t.split(i).map(function (e) {
                return e.trim();
              }).filter(function (e) {
                return 0 !== e.length;
              }).map(this.addTag);
            }
            (!!this.allowDuplicates || -1 === this.tags.indexOf(t)) && this.beforeAdding(t) && (this.tags.push(this.createTag(t)), this.$emit("input", this.tags), this.$emit("add", t));
          }
          this.newTag = "";
        },
        getNormalizedTagText: function getNormalizedTagText(e) {
          return "object" === t(e) && (e = h(e, this.field)), "".concat(e);
        },
        customOnBlur: function customOnBlur(e) {
          this.autocomplete || this.addTag(), this.onBlur(e);
        },
        onSelect: function onSelect(e) {
          var t = this;
          e && (this.addTag(e), this.$nextTick(function () {
            t.newTag = "";
          }));
        },
        removeTag: function removeTag(e, t) {
        ...
        keydown: function keydown(e) {
          var t = e.key;
          -1 === this.removeOnKeys.indexOf(t) || this.newTag.length || this.removeLastTag(), this.autocomplete && !this.allowNew || this.confirmKeys.indexOf(t) >= 0 && ("Tab" !== t && e.preventDefault(), this.addTag());
        },
  ...
  var Ci,
    ...
    _i = {
      open: function open(e) {
        ...
        e.parent && (t = e.parent, delete e.parent), Array.isArray(e.message) && (i = e.message, delete e.message);
        var a = m(n, e),
          s = new (("undefined" != typeof window && window.Vue ? window.Vue : Ci || P).extend(xi))({
            parent: t,
            el: document.createElement("div"),
            propsData: a
          });
        ...
        onFileChange: function onFileChange(e) {
          if (!this.disabled && !this.loading) {
            ...
            if (0 === t.length) {
              ...
              var s = t[0];
              if (this.checkType(s)) this.newValue = s;else {
                if (!this.newValue) return;
                this.newValue = null;
              }
            }
